    ...
    <article className="mx-auto max-w-2xl px-6 pb-24 pt-32">
      ...
      <div className="text-muted-foreground mt-8 space-y-5 leading-relaxed">
        ...
        <p>
          ...
          lands an NVIDIA B200 at $2.36/GPU/hr — about 31% below CoreWeave list. That reserved base
        ...
        <p>
          ...
          roughly 45% under AWS Bedrock — with data that never leaves the metro.
        </p>
      </div>
      <div className="mt-10">
        <Button asChild>
